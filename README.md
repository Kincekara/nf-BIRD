...
```bash
nextflow run /path/to/nf-BIRD -profile docker --input /path/to/samplesheet.csv --kraken2_db /path/to/k2_standard_08gb_20250402.tar.gz --checkm2_db /path/to/checkm2_database.tar.gz --outdir /path/to/your_out_dir/
```
